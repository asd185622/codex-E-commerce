...
public class OrderControllerTest {
    ...
    @Test
    public void getOrders_otherUser_isForbidden() throws Exception {
    ...
    @Test
    public void getOrders_withoutSession_isUnauthorized() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/users/{userId}/orders", 1))
                .andExpect(status().isUnauthorized());
    }

    private MallUserPrincipal principal(Integer userId) {
        return new MallUserPrincipal(userId, "user" + userId + "@gmail.com", "password");
    }
}
